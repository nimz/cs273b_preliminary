...
class SimpleConv(indel_model.IndelModel):
    ...
    def add_prediction_op(self):
        ...
        W_fc1 = utils.weight_variable([self.config.strlen * 80, 1024])
...
auroc = conv_net.calc_roc(sess, 'splitconv_auroc.png')
print("ROC AUC: %g" % auroc)
auprc = conv_net.calc_auprc(sess, 'splitconv_auprc.png')
print("PR AUC: %g" % auprc)
print("f1 score: %g" % conv_net.calc_f1(sess))
conv_net.print_confusion_matrix(sess)

conv_net.plot_val_accuracies('splitconv_val.png')
